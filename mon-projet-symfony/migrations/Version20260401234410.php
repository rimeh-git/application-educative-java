 ...
 */
final class Version20260401234410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activite ADD nom VARCHAR(255) DEFAULT NULL, DROP score, DROP duree, DROP resultat, DROP type_activite, CHANGE bonne_reponse bonne_reponse VARCHAR(255) DEFAULT NULL, CHANGE jeu_id jeu_id INT NOT NULL, CHANGE question question LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activite ADD score INT DEFAULT NULL, ADD duree INT DEFAULT NULL, ADD resultat VARCHAR(50) DEFAULT NULL, ADD type_activite VARCHAR(50) DEFAULT NULL, DROP nom, CHANGE question question TEXT DEFAULT NULL, CHANGE bonne_reponse bonne_reponse VARCHAR(100) DEFAULT NULL, CHANGE jeu_id jeu_id INT DEFAULT NULL');
