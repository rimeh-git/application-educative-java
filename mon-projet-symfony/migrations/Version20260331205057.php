 ...
 */
final class Version20260331205057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activite ADD nom VARCHAR(255) NOT NULL, ADD img1 VARCHAR(255) DEFAULT NULL, ADD img2 VARCHAR(255) DEFAULT NULL, ADD img3 VARCHAR(255) DEFAULT NULL, ADD img4 VARCHAR(255) DEFAULT NULL, ADD bonne_image VARCHAR(255) DEFAULT NULL, DROP score, DROP duree, DROP resultat, DROP type_activite, CHANGE bonne_reponse bonne_reponse VARCHAR(255) DEFAULT NULL, CHANGE jeu_id jeu_id INT NOT NULL, CHANGE question question LONGTEXT DEFAULT NULL, CHANGE image_url image VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE jeu_educatif ADD nom VARCHAR(255) NOT NULL, DROP description, DROP image, DROP deleted, CHANGE type type VARCHAR(50) NOT NULL, CHANGE niveau niveau VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activite ADD image_url VARCHAR(255) DEFAULT NULL, ADD score INT DEFAULT NULL, ADD duree INT DEFAULT NULL, ADD resultat VARCHAR(50) DEFAULT NULL, ADD type_activite VARCHAR(50) DEFAULT NULL, DROP nom, DROP image, DROP img1, DROP img2, DROP img3, DROP img4, DROP bonne_image, CHANGE question question TEXT DEFAULT NULL, CHANGE bonne_reponse bonne_reponse VARCHAR(100) DEFAULT NULL, CHANGE jeu_id jeu_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE jeu_educatif ADD description TEXT DEFAULT NULL, ADD image VARCHAR(255) DEFAULT NULL, ADD deleted TINYINT DEFAULT 0, DROP nom, CHANGE type type VARCHAR(50) DEFAULT NULL, CHANGE niveau niveau VARCHAR(50) DEFAULT NULL');
    }
}
