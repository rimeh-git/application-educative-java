...
class SuiviProgression
{
    ...
    // ============ RELATION SIMPLIFIÉE ============
    #[ORM\ManyToOne(targetEntity: Session::class, inversedBy: 'suiviProgressions')]
    ...
    public function getScoreAvant(): ?int { return $this->scoreAvant; }
    public function setScoreAvant(?int $scoreAvant): static { $this->scoreAvant = $scoreAvant; return $this; }

    public function getScoreApres(): ?int { return $this->scoreApres; }
    public function setScoreApres(?int $scoreApres): static { $this->scoreApres = $scoreApres; return $this; }

    public function getProgression(): ?int { return $this->progression; }
    public function setProgression(?int $progression): static { $this->progression = $progression; return $this; }

    public function getComportementsObserves(): ?string { return $this->comportementsObserves; }
    public function setComportementsObserves(?string $comportementsObserves): static { $this->comportementsObserves = $comportementsObserves; return $this; }

    public function getDeclencheursIdentifies(): ?string { return $this->declencheursIdentifies; }
    public function setDeclencheursIdentifies(?string $declencheursIdentifies): static { $this->declencheursIdentifies = $declencheursIdentifies; return $this; }

    public function getObjectifsRealises(): ?string { return $this->objectifsRealises; }
    public function setObjectifsRealises(?string $objectifsRealises): static { $this->objectifsRealises = $objectifsRealises; return $this; }

    public function getRecommandationsParent(): ?string { return $this->recommandationsParent; }
    public function setRecommandationsParent(?string $recommandationsParent): static { $this->recommandationsParent = $recommandationsParent; return $this; }
